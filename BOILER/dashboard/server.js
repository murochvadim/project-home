...
app.get('/api/health/db-volumes', async (req, res) => {
  try {
    ...
    const tsCol = {
      ...
      household_users: 'created_at', ph_profiles: 'created_at', ph_measurements: 'measured_at', ph_medications: 'created_at', ph_bp: 'measured_at', ph_steps: 'measured_at', reminder_state: 'updated_at',
